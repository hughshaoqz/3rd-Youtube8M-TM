...
flags.DEFINE_integer("nextvlad_cluster_size", 0, "Number of units in the NeXtVLAD cluster layer.")
flags.DEFINE_integer("nextvlad_hidden_size", 0, "Number of units in the NeXtVLAD hidden layer.")
...
class BertMixNeXtVladModel(models.BaseModel):
