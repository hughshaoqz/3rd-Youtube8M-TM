...
class ModelExporter(object):
  ...
  def __init__(self, frame_features, model, reader):
    ...
    self.model = model
    self.reader = reader
    if FLAGS.nextvlad_cluster_size:
      self.cluster_size = FLAGS.nextvlad_cluster_size
      self.hidden_size = FLAGS.nextvlad_hidden_size
    else:
      self.cluster_size = FLAGS.netvlad_cluster_size
      self.hidden_size = FLAGS.netvlad_hidden_size
  ...
  def build_prediction_graph(self, serialized_examples):
    ...
    sample_random_frames = FLAGS.sample_random_frames
